...
public class ShopController {
  ...
  public ResponseEntity<List<Map<String, Object>>> getShop(@PathVariable Long characterId) {
    Character character = characterRepo.findById(characterId).orElseThrow(() -> new RuntimeException("Character not found"));
    List<Map<String, Object>> items = shopService.generateShopItems(character);
